...
- **Workflow overview** home — expandable node graph of stages, parallel child tasks that gate the next stage, *labor market test* vs *Upravno vijeće* split, and loop-backs; click a node for read-only details, then open the checklist step to make changes
